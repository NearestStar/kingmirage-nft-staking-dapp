  ...
  const getInfo = async () => {
    if (data.network === networksMap[networkDeployedTo]) {
      ...
      const stakedTokens = Array.from(
        await staking_contract.tokensOfOwner(user),
        (x) => Number(x)
      );
      const reward = await staking_contract.getTotalRewardEarned(user);

      const paused = await nft_contract.paused();
      var userTokens = Array.from(await nft_contract.tokensOfOwner(user), (x) =>
        Number(x)
      );
  ...
  return (
    <section>
        ...
        <div className="roadmap-container">
          ...
          <div className="info-container">
            ...
            <Table responsive>
              <tbody>
                <tr>
                  <td className="p-2">Your KingMirages </td>
            ...
            <div className="row" style={{ justifyContent: "center" }}>
              <div className="col-md-7">
                <div className="text-center">
                  <h2 className="minttitle title">Claim Your KingMirage</h2>
                  <img src={image1} className="mint-img" alt="" />
                  <p className="lead" style={{ marginBottom: "30px" }}>
                    A KingMirage is a character that is part of an 10000
      ...
      <section className="my-items">
        {userNfts.length !== 0 ? (
          <>
            <h2 className="minttitle title text-center">My KingMirages</h2>
